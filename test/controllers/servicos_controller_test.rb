...
class ServicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create servico" do
    assert_difference("Servico.count") do
      post servicos_url, params: { servico: { descricao: @servico.descricao, valor: @servico.valor } }
    end
  ...
  test "should update servico" do
    patch servico_url(@servico), params: { servico: { descricao: @servico.descricao, valor: @servico.valor } }
