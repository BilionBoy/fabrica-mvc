...
class CategoriaProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categoria_produto" do
    assert_difference("CategoriaProduto.count") do
      post categoria_produtos_url, params: { categoria_produto: { ativo: @categoria_produto.ativo, descricao: @categoria_produto.descricao, empresa_id: @categoria_produto.empresa_id, nome: @categoria_produto.nome } }
    end
  ...
  test "should update categoria_produto" do
    patch categoria_produto_url(@categoria_produto), params: { categoria_produto: { ativo: @categoria_produto.ativo, descricao: @categoria_produto.descricao, empresa_id: @categoria_produto.empresa_id, nome: @categoria_produto.nome } }
