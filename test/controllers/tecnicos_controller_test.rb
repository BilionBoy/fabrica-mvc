...
class TecnicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tecnico" do
    assert_difference("Tecnico.count") do
      post tecnicos_url, params: { tecnico: { funcao: @tecnico.funcao, nome: @tecnico.nome, telefone: @tecnico.telefone } }
    end
  ...
  test "should update tecnico" do
    patch tecnico_url(@tecnico), params: { tecnico: { funcao: @tecnico.funcao, nome: @tecnico.nome, telefone: @tecnico.telefone } }
