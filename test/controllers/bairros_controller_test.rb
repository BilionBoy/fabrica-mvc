...
class BairrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bairro" do
    assert_difference("Bairro.count") do
      post bairros_url, params: { bairro: { municipio_id: @bairro.municipio_id, nome: @bairro.nome } }
    end
  ...
  test "should update bairro" do
    patch bairro_url(@bairro), params: { bairro: { municipio_id: @bairro.municipio_id, nome: @bairro.nome } }
